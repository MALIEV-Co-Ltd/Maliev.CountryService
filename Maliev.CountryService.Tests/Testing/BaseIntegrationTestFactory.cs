...
/// <summary>
/// Base integration test factory for CountryService.
    ...
    public async Task ClearRedisCacheAsync()
    {
        if (_redisContainer != null)
        {
            ...
            catch (Exception ex)
            {
                ...
                var logger = loggerFactory.CreateLogger("BaseIntegrationTestFactory");
                logger.LogError(ex, "Error flushing Redis");
            }
        }
    }
