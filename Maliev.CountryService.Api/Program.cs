...
try
{
    bootstrapLogger.LogInformation("Starting Country Service host");
...
{
    bootstrapLogger.LogCritical(ex, "Country Service host terminated unexpectedly during startup");
    throw;
}
finally
{
